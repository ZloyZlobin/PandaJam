...
Simple prototype of a game like Panda Jam (on Facebook)
...
Simple version with up to 3 predesigned levels (or a random level generator) and include 3 of the following extra features:
